      ...
      <div className="space-y-6">
        ...
        <div className={`rounded-xl p-6 ${isDarkMode ? 'bg-gray-700/30' : 'bg-white border border-gray-200'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'} mt-1`}>
                    Secure online payment through our platform. Get paid faster with digital transactions.
                  </p>
                  <div className="mt-2">
            ...
            <div 
              className={`relative p-6 rounded-lg border-2 cursor-pointer transition-all duration-200 ${
                formData.paymentMethod === 'handover'
                  ? isDarkMode 
                    ? 'border-blue-500 bg-blue-500/10' 
                    : 'border-blue-500 bg-blue-50'
                  : isDarkMode
              ...
              onClick={() => handleInputChange('paymentMethod', 'handover')}
            >
              <input
                type="radio"
                name="paymentMethod"
                value="handover"
                checked={formData.paymentMethod === 'handover'}
                onChange={() => handleInputChange('paymentMethod', 'handover')}
                className="absolute top-4 right-4"
              />
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className={`font-semibold text-lg ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                    Hand Over After Completion
                  </h3>
                  <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'} mt-1`}>
                    Payment upon project completion and delivery. Traditional payment method.
                  </p>
                  <div className="mt-2">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className={`text-sm ${isDarkMode ? 'text-blue-300' : 'text-blue-700'}`}>
                  <strong>Payment Terms:</strong> Your selected payment method will be communicated to the client. 
                  Final payment terms will be agreed upon during the hiring process.
                </p>
              </div>
            </div>
          </div>
