  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'} transition-colors duration-300`}>
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        {/* Setup Form */}
        <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl p-8 shadow-sm border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'} mb-8`}>
          <div className="space-y-8">
            ...
            <div className="text-center">
              ...
              <div className="relative inline-block">
                <div className={`w-32 h-32 rounded-full border-4 ${isDarkMode ? 'border-gray-600 bg-gray-700' : 'border-gray-300 bg-gray-100'} flex items-center justify-center overflow-hidden`}>
                  {clientData.profilePhoto ? (
                    ...
                    <Camera className={`w-12 h-12 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`} />
                  )}
                </div>
                ...
                <label
                  ...
                  className="absolute bottom-0 right-0 w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center text-white cursor-pointer hover:bg-blue-600 transition-colors"
                >
              ...
              <div>
                ...
                <div className="flex space-x-3">
                  <input
                    ...
                    className={`flex-1 px-4 py-3 rounded-lg border ${isDarkMode ? 'bg-gray-700 border-gray-600 text-white' : 'bg-white border-gray-300 text-gray-900'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                  />
                  <button
            ...
            {/* Benefits */}
            <div className={`p-6 rounded-lg ${isDarkMode ? 'bg-blue-900/20 border-blue-500/30' : 'bg-blue-50 border-blue-200'} border`}>
              <h4 className={`font-semibold ${isDarkMode ? 'text-blue-300' : 'text-blue-800'} mb-3`}>
        ...
        <div className="flex items-center justify-between">
          <button
            onClick={handleBack}
            className={`flex items-center space-x-2 px-6 py-3 rounded-lg border ${isDarkMode ? 'border-gray-600 text-gray-300 hover:bg-gray-700' : 'border-gray-300 text-gray-700 hover:bg-gray-50'} transition-colors`}
          >
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              className={`px-6 py-3 rounded-lg ${isDarkMode ? 'text-gray-400 hover:text-gray-300' : 'text-gray-600 hover:text-gray-700'} transition-colors`}
            >
              Skip for now
            </button>
