    ...
    <div className="space-y-2 sm:space-y-2 p-2 sm:p-2">
      ...
      <form onSubmit={handleSubmit} className="space-y-2 sm:space-y-2">
        ...
        <div className={sectionClasses}>
          <h2 className={`text-lg sm:text-xl font-semibold mb-4 sm:mb-3 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
            Basic Job Information
          </h2>
          
          {/* Form Status Messages */}
          {submitStatus === 'error' && (
            <div className={`p-1 sm:p-2 rounded-xl mb-2 sm:mb-4 ${isDarkMode ? 'bg-red-500/20 border border-red-500/30' : 'bg-red-50 border border-red-200'}`}>
        ...
        {/* Job Description */}
        <div className={sectionClasses}>
          <h2 className={`text-lg sm:text-xl font-semibold mb-2 sm:mb-3 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
            Job Description
          </h2>
